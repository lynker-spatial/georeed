...
#' @param primary_column `character(1)`
...
#' @param geometry_types `character(N)`
#'        The geometry types of all geometries,
#'        or an empty array if they are not known.
#' @param ...
#'        Additional named arguments included in the returned list.
...
#' Create Hydrofabric-specific GeoParquet metadata
#' @param .data `sf`
...
#'
#' @example
#' geoparquet_metadata(df, my_extra_meta = list(copyright_holder = "acme"))
#'
#' @return `list`
#' @export
